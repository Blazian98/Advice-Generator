...
public class QuizDbHelper extends SQLiteOpenHelper {
    ...
    private void fillCategoriesTable() {
        ...
        insertCategory(c1);
        Category c2 = new Category("Beef");
        insertCategory(c2);
        Category c3 = new Category("Chicken");
        insertCategory(c3);
        Category c4 = new Category("Pork");
        insertCategory(c4);
        Category c5 = new Category("Lamb");
        insertCategory(c5);
        Category c6 = new Category("Seafood");
        insertCategory(c6);
        Category c7 = new Category("Pasta");
        insertCategory(c7);
        Category c8 = new Category("Vegetarian");
        insertCategory(c8);
    }

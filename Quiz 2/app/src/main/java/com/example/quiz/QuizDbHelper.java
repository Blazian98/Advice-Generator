...
public class QuizDbHelper extends SQLiteOpenHelper {
    ...
    private void fillQuestionsTable() {
        ...
        Question q4 = new Question("Math, A is correct",
                ...
                Category.Lamb);
        insertQuestion(q4);
        Question q5 = new Question("Non existing, A is correct",
                "A", "B", "C", "D", 1,
                Category.Seafood);
        insertQuestion(q5);
        Question q6 = new Question("Non existing, B is correct",
                ...
                Category.Pasta);
        insertQuestion(q6);
        Question q7 = new Question("Non existing, D is correct",
                "A", "B", "C", "D", 4,
                Category.Vegetarian);
        insertQuestion(q7);
        Question q8 = new Question("Non existing, C is correct",
                "A", "B", "C", "D", 3,
                Category.Dessert);
        insertQuestion(q7);
    }
